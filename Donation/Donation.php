...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `donation` (`D_ID`, `Name`, `Mobile`) VALUES ('$d_id', '$name', '$mobile')";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: donation_index.php?msg=New record created successfully");
    } else {
...
<body>
    <nav class="navbar navbar-light justify-content-between fs-3 mb-5" style="background-color: #00ff5573;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fas fa-donate me-2"></i> Donation - Add New Entry
            </a>
            <div>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Complete the form below to add a new donation</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div>
                    ...
                    <a href="donation_index.php" class="btn btn-danger">Cancel</a>
                </div>
            </form>
        </div>
    </div>
