...
<head>
  ...
  <title>OMS - Trust Management</title>
</head>
...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="Trust.php" class="btn btn-dark mb-3">Add</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit_trust.php?id=<?php echo $row["ID"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="delete_trust.php?id=<?php echo $row["ID"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
