...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `House_Parent` (`Name`, `HP_ID`, `Mobile`, `E_mail`) VALUES ('$name', '$hp_id', '$mobile', '$email')";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: HouseParent_index.php?msg=New record created successfully");
    } else {
...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <title>Add New House Parent</title>
</head>
...
<body>
    <nav class="navbar navbar-light justify-content-between fs-3 mb-5" style="background-color: #00ff5573;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fas fa-user-friends me-2"></i> House Parent - New Entry
            </a>
            <div>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Add New House Parent</h3>
            <p class="text-muted">Complete the form below to add a new house parent</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" placeholder="House Parent Name">
                </div>
                ...
                <div>
                    ...
                    <a href="HouseParent_index.php" class="btn btn-danger">Cancel</a>
                </div>
            </form>
        </div>
    </div>
