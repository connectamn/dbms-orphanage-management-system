...
<head>
  ...
  <title>OMS - House Parent Management</title>
</head>
...
<body>
  <nav class="navbar navbar-light justify-content-between fs-3 mb-5" style="background-color: #00ff5573;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <i class="fas fa-user-friends me-2"></i> OMS - House Parent Management
            </a>
            <div>
  ...
  <div class="container">
    ...
    ?>
    <a href="HouseParent.php" class="btn btn-dark mb-3">Add</a>

    <table class="table table-hover text-center">
      <thead class="table-dark">
        <tr>
          <th scope="col">House Parent ID</th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="edit_HouseParent.php?id=<?php echo $row["HP_ID"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="delete_HouseParent.php?id=<?php echo $row["HP_ID"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
